...
public class HiddenResourceTests
{
    ...
    public void DiscoverHiddenEnumProperties()
    {
        ...
        var middleResource =
            result.First(r => r.Key == "DbLocalizationProvider.Tests.HiddenResourcesTests.SomeEnumWithHiddenResources.Some");
    ...
    public void DiscoverHiddenEnumProperties_WithHiddenAttributeOnClassProperties()
    {
        ...
        var middleResource =
            result.First(r => r.Key == "DbLocalizationProvider.Tests.HiddenResourcesTests.SomeEnumWithAllHiddenResources.Some");
        Assert.True(middleResource.IsHidden);
    }
    ...
    public void DiscoverHiddenResourceProperties()
    {
        ...
        var secondResource = result.First(r => r.Key
                                               == "DbLocalizationProvider.Tests.HiddenResourcesTests.SomeResourcesWithHiddenProperties.AnotherProperty");
