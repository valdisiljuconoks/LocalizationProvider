...
public class AvailableLanguage
{
    ...
    /// Display name of the language (might be different from Name or EnglishName of the CultureInfo set for the
    /// available language).
    /// </param>
    ...
    public static AvailableLanguage Invariant =>
        new(CultureInfo.InvariantCulture.EnglishName, 0, CultureInfo.InvariantCulture);
}
