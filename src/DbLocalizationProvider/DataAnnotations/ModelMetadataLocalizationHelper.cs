...
namespace DbLocalizationProvider.DataAnnotations
{
    ...
    internal class ModelMetadataLocalizationHelper
    {
        ...
        internal static string GetTranslation(string resourceKey)
        {
            ...
            if (!ConfigurationContext.Current.ModelMetadataProviders.EnableLegacyMode())  return result;
            ...
            if (UseLegacyMode(localizedDisplayName))  result = LocalizationProvider.Current.GetString(localizedDisplayName);
