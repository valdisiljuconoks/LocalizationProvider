    ...
    public class JsonConverter
    {
            ...
            bool camelCase)
        {
            return Convert(resources,
                           language,
                           new Dictionary<string, FallbackLanguagesList>
                           {
                               { "default", new FallbackLanguagesList { fallbackCulture } }
                           },
                           camelCase);
        }
            ...
            bool camelCase)
        {
            ...
            foreach (var resource in resources)
            {
                ...
                var translation =
                    resource.Translations.GetValueWithFallback(language, language.GetFallbackLanguageList(fallbackList));
