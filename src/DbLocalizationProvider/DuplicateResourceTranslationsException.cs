...
namespace DbLocalizationProvider
{
    ...
    public class DuplicateResourceTranslationsException : Exception
    {
        ...
        /// </param>
        public DuplicateResourceTranslationsException(string message, Exception innerException) :
        ...
        /// </param>
        protected DuplicateResourceTranslationsException(SerializationInfo info, StreamingContext context) :
            base(info, context) { }
    }
}
